...
| is_child_account | bool             | Check if user is a child account.                                                 | 0.1.0   |
...
**Returns:** `array{
      active: \WP_User[]|array,
      pending: array
 }`

**Description:** Retrieves the active and pending child accounts associated with this parent account.
